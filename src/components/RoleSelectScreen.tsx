      ...
      <div className="w-full max-w-2xl space-y-8">
        <div className="flex flex-col items-center text-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">Control de Defectos & Galería Fotográfica</p>
          </div>
        </div>
        ...
        {!askingPin ? (
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-bold text-slate-900">Acceso Editor</h2>
            </div>
            <div className="space-y-1.5">
              ...
              />
              {error && <p className="text-xs text-rose-600">Contraseña incorrecta</p>}
            </div>
